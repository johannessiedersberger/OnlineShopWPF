...
//      commandMock.SetupGet(p => p.Parameters).Returns(default(IDataParameterCollection));
...
//      db.Setup(d => d.Open());
//      db.Setup(d => d.CreateQueryCommand(CPU.CommandAddCPU)).Returns(commandMock.Object);
